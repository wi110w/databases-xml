...
urlpatterns = [
    ...
    url(r'^reader/(?P<reader_name>[A-Za-z]+)/$', views.detail_reader, name='detail_reader'),
    url(r'^librarian/(?P<lib_name>[A-Za-z]+)/$', views.detail_librarian, name='detail_librarian'),
    url(r'^book/(?P<book_title>[ A-Z a-z ]+)/$', views.detail_book, name='detail_book'),
