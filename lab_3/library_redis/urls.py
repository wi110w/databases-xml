...
app_name = 'library_redis'
urlpatterns = [
    url(r'^$', views.index, name='index'),
    url(r'^(?P<record_num>[0-9]+)/$', views.detail, name='detail'),
    url(r'^reader/(?P<reader_id>[0-9A-Za-z]+)/$', views.detail_reader, name='detail_reader'),
    url(r'^librarian/(?P<lib_id>[0-9A-Za-z]+)/$', views.detail_librarian, name='detail_librarian'),
    url(r'^book/(?P<book_id>[0-9A-Za-z]+)/$', views.detail_book, name='detail_book'),
